...
function getData(req, res, version) {
	...
	if (version === 4) genshindb.setOptions({ v4PropsOnly: true });
	else if (version === 5) genshindb.setOptions({ v4Props: false, v4PropsOnly: false });
...
function enableCors(req, res) {
	res.setHeader('Cache-Control', 'public, maxage=5, immutable');
